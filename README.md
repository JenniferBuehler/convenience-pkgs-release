## jb_common_libs (indigo) - 1.0.0-0

The packages in the `jb_common_libs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release jb_common_libs --track indigo --rosdistro indigo` on `Thu, 09 Jun 2016 09:05:05 -0000`
