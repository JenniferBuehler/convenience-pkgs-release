Name:           ros-indigo-baselib-binding
Version:        1.0.0
Release:        0%{?dist}
Summary:        ROS baselib_binding package
...
%description
Includes headers to provide loose coupling to core functionalities such as
threads and shared pointers: can switch between std c++11 threads/shared
pointers or boost.
