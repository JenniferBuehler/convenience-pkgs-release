Name:           ros-indigo-arm-components-name-manager
Version:        1.0.0
Release:        0%{?dist}
Summary:        ROS arm_components_name_manager package
...
%description
Can be used to configure robot arm component names and access them conveniently
